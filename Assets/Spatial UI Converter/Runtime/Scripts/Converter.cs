...
/*        [Tooltip("The width of the backplate.")]
        ...
        private bool AllPrefabExist() {
            if (!backplateBase) {
                Debug.LogError($"UI Backplate is not found under Packages/com.microsoft.mixedreality.toolkit.foundation/SDK/StandardAssets/Prefabs/, make sure you installed MRTK of a version at least {ConverterConstants.MRTKVersion}");
                return false;
            }
            if (!buttonBase) {
                Debug.LogError($"PressableButtonHoloLens2 is not found under Packages/com.microsoft.mixedreality.toolkit.foundation/SDK/Features/UX/Interactable/Prefabs/, make sure you installed MRTK of a version at least {ConverterConstants.MRTKVersion}.");
                return false;
            }
            if (!labelBase) {
                Debug.LogError($"UITextSelawik is not found under Packages/com.microsoft.mixedreality.toolkit.foundation/SDK/StandardAssets/Prefabs/Text/, make sure you installed MRTK of a version at least {ConverterConstants.MRTKVersion}.");
                return false;
            }
            if (!toggleBase) {
                Debug.LogError($"PressableButtonHoloLens2Toggle is not found under Packages/com.microsoft.mixedreality.toolkit.foundation/SDK/Features/UX/Interactable/Prefabs/, make sure you installed MRTK of a version at least {ConverterConstants.MRTKVersion}.");
                return false;
            }
            if (!sliderBase) {
                Debug.LogError($"PinchSlider is not found under Packages/com.microsoft.mixedreality.toolkit.foundation/SDK/Features/UX/Prefabs/Sliders/, make sure you installed MRTK of a version at least {ConverterConstants.MRTKVersion}.");
                return false;
            }
            if (!stepSliderBase) {
                Debug.LogError($"StepSlider is not found under Packages/com.microsoft.mixedreality.toolkit.foundation/SDK/Experimental/StepSlider/, make sure you installed MRTK of a version at least {ConverterConstants.MRTKVersion}.");
            }
            if (!textFieldBase) {
                Debug.LogError($"MRKeyboardInputField_TMP is not found under Packages/com.microsoft.mixedreality.toolkit.foundation/SDK/Experimental/MixedRealityKeyboard/Prefabs/, make sure you installed MRTK of a version at least {ConverterConstants.MRTKVersion}.");
            }
            return true;
        }
